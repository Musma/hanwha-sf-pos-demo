...
const required = [
  ...
  'data-uijang-wf-confirm-open=""',
  'id="uijang-wf-confirm-modal"',
  'W/F 점검을 확정하시겠습니까?',
  'data-uijang-wf-confirm-submit=""',
  'data-uijang-wf-confirm-cancel=""',
  ...
  'data-plan-deploy-open=""',
  'id="plan-deploy-confirm"',
  '계획을 배포하시겠습니까?',
  'data-plan-deploy-confirm=""',
  'data-plan-deploy-edit=""',
  'id="plan-deploy-progress"',
  'id="plan-deploy-progress-bar"',
  '대상 시스템으로 계획을 전송하고 있습니다.',
  'id="plan-deploy-success"',
  '배포 완료되었습니다.',
  '{{ deployPlanConfirm }}',
