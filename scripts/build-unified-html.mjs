...
const weeklyVolumeHeader = weeklyVolumeColumns
  .map((label) => {
    ...
    return `<th${attrs} style="background:#ffff00;border:1px solid #b9b9b9;padding:3px 6px;color:#111;font-size:12px;font-weight:700;line-height:1.25;position:sticky;top:0;">${content}</th>`;
  })
  .join('');
